...
var CatererService = (function () {
    function CatererService(http) {
        ...
        this.caterers_req = "/caterers";
    }
    CatererService.prototype.getCaterers = function () {
    ...
    CatererService.prototype.extractCaterersData = function (res) {
        var body = res.json();
        return body['caterers'];
    };
    CatererService.prototype.extractCatererData = function (res) {
        var body = res.json();
        return body;
    };
    CatererService.prototype.handleError = function (error) {
...
exports.CatererService = CatererService;
//# sourceMappingURL=caterer.service.js.map